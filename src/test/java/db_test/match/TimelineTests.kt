...
class TimelineTests {
    ...
    fun ensureThatWeCanFetchByParticipantRowId() {
        ...
        Assert.assertEquals(timeline.creepsPerMinDeltas.thirtyToEnd ,timeline2.creepsPerMinDeltas.thirtyToEnd, 0.05)
        ...
        Assert.assertEquals(timeline.damageTakenDiffPerMinDeltas.thirtyToEnd, timeline2.damageTakenDiffPerMinDeltas.thirtyToEnd, 0.05)
        ...
        Assert.assertEquals(timeline.damageTakenPerMinDeltas.thirtyToEnd ,timeline2.damageTakenPerMinDeltas.thirtyToEnd, 0.05)
        ...
        Assert.assertEquals(timeline.goldPerMinDeltas.thirtyToEnd ,timeline2.goldPerMinDeltas.thirtyToEnd, 0.05)
        ...
        Assert.assertEquals(timeline.csDiffPerMinDeltas.thirtyToEnd, timeline2.csDiffPerMinDeltas.thirtyToEnd, 0.05)
        ...
        Assert.assertEquals(timeline.xpDiffPerMinDeltas.thirtyToEnd, timeline2.xpDiffPerMinDeltas.thirtyToEnd, 0.05)
        ...
        Assert.assertEquals(timeline.xpPerMinDeltas.thirtyToEnd, timeline2.xpPerMinDeltas.thirtyToEnd, 0.05)
        Assert.assertTrue(timeline.role == timeline2.role)
        Assert.assertTrue(timeline.role == timeline2.role)
    }
}